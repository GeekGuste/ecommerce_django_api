...
class DeliveryZoneInfoSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        # fields = '__all__'
        fields = ("id", "zone", "delivery_charges")
...
class CategoryCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ("id", "label", "image", "is_active", "parent_id")
    ...
    def get_enfants(self, instance):
        if instance.enfants is not None:
            return CategorySerializer(
                instance.enfants.filter(has_at_least_one_product=True)
            ).data
        else:
            return None
...
class CategoryTreeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Category
        fields = ("id", "label", "image", "is_active", "enfants")
...
class OrderProductSerializer(serializers.ModelSerializer):
    class Meta:
        model = OrderProduct
        fields = ("id", "product", "label", "price", "quantity", "image_url")
